...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    hass.http.register_static_path("/yandex-music-browser", card_file_path, False)
    add_extra_js_url(hass, "/yandex-music-browser/media-player.js?cache=" + str(time.time()), es5=False)
