...
var styles$8 = css`:host{display:block;transition:filter .8s ease 0s}:host .fill{background-color:var(--ymp-background-color);bottom:0;left:0;position:absolute;right:0;top:0;transition:background-color .8s ease 0s}:host .image{background-color:var(--ymp-background-color);background-image:var(--ymp-media-image);background-position:50%;background-repeat:no-repeat;background-size:cover;bottom:0;opacity:1;position:absolute;right:0;top:0;transition:width .8s ease 0s,background-image .8s ease 0s,background-color .8s ease 0s,background-size .8s ease 0s,opacity .8s linear .8s;width:var(--ymp-media-image-width)}:host .gradient{background-image:var(--ymp-media-horizontal-gradient);bottom:0;opacity:1;position:absolute;right:0;top:0;transition:width .8s ease 0s,background-image .8s ease 0s,opacity .8s linear .8s;width:var(--ymp-media-image-width)}`;
...
class YmpBackground extends LitElement {
    constructor() {
         ...
         */
        this._cardHeight = 0;
        this._fallbackImage = '/yandex-player/no-image.png';
    }
...
var styles$7 = css`:host{background-image:var(--ymp-media-vertical-gradient);display:block;height:40px;position:relative;z-index:5}:host .durations{align-items:center;color:var(--ymp-text-primary);display:flex;font-size:10px;height:20px;justify-content:space-between;left:0;opacity:1;padding:0 8px;position:absolute;right:0;top:10px;transition:opacity .2s ease-out}:host .durations .pale{opacity:.75}:host .progress-bar{bottom:0;cursor:pointer;height:4px;left:0;position:absolute;right:0;transition:height .2s ease-out 0s}:host .progress-bar .bar{background-color:var(--ymp-interface-color);height:100%;position:relative;transition:width .2s ease-out,background-color .2s ease-out;width:0;z-index:2}:host .progress-bar .bar-background{background-color:var(--ymp-background-alfa-color);bottom:0;left:0;position:absolute;right:0;top:0}:host(:hover) .progress-bar{height:10px}:host([disabled]){pointer-events:none}:host([disabled]) .durations{opacity:0}:host([disabled]) .progress-bar{height:4px}:host([disabled]) .progress-bar .bar{background-color:var(--ymp-disabled-color)}:host([disabled]) .progress-bar .bar-background{background-color:var(--ymp-disabled-color)}`;
...
var styles$6 = css`:host{--paper-slider-max-width:200px;--paper-slider-height:4px;--calculated-paper-slider-height:2px;--paper-slider-knob-color:var(--ymp-interface-color);--paper-slider-active-color:var(--ymp-interface-color);--paper-slider-pin-color:var(--ymp-interface-color);--paper-slider-secondary-color:var(--ymp-text-primary);--paper-slider-disabled-knob-color:var(--ymp-text-primary);--paper-progress-container-color:var(--ymp-background-alfa-color);--paper-slider-container-color:var(--ymp-background-alfa-color);align-items:center;display:flex;max-width:calc(var(--mdc-icon-button-size) + var(--paper-slider-max-width));width:100%}:host .mute{height:var(--mdc-icon-button-size);min-width:var(--mdc-icon-button-size);width:var(--mdc-icon-button-size)}:host .volume{padding:0 calc(15px + var(--calculated-paper-slider-height)/2);width:calc(100% - var(--mdc-icon-button-size))}:host .volume .slider-wrap{left:calc(-15px - var(--calculated-paper-slider-height)/2);position:relative}`;
...
var styles$5 = css`:host{align-items:flex-end;display:flex;justify-content:space-between}:host .buttons-action{--mdc-icon-button-size:32px;--mdc-icon-size:18px;display:none}`;
...
var styles$4 = css`:host{--disabled-text-color:var(--ymp-text-primary);color:var(--ymp-text-primary)}@keyframes rotate{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}@-moz-keyframes rotate{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}`;
...
var styles$3 = css`:host{--mdc-icon-button-size:52px;--mdc-icon-size:36px;--divider-color:#00000000;background:transparent;border:none;color:var(--ymp-text-primary);display:block;margin-right:14px;padding:0;position:relative;text-align:center}`;
...
var styles$2 = css`:host{color:var(--ymp-text-primary);font-size:18px;font-weight:400;letter-spacing:-.012em;line-height:22px;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}`;
...
var styles$1 = css`:host{--ymp-inned-shadow:linear-gradient(90deg,transparent 0%,#000 5%,#000 95%,transparent);color:var(--ymp-text-primary);display:block;font-size:13px;font-weight:400;line-height:14px;opacity:.8;overflow:hidden;position:relative;text-overflow:ellipsis;white-space:nowrap}:host .container{animation-duration:0s}:host .hold-line{visibility:visible}:host .move-line-wrap{animation-duration:inherit;bottom:0;left:0;-webkit-mask-image:var(--ymp-inned-shadow);position:absolute;right:0;top:0;visibility:hidden}:host .move-line-wrap .move-line{animation:slide 0s linear 0s infinite normal none running;animation-duration:inherit;min-width:fit-content;white-space:nowrap;width:fit-content}:host .move-on .hold-line{visibility:hidden}:host .move-on .move-line-wrap{visibility:visible}@keyframes slide{0%{transform:translateX(0)}to{transform:translateX(-100%)}}@-moz-keyframes slide{0%{transform:translateX(0)}to{transform:translateX(-100%)}}`;
...
class MediaPlayerCard extends LitElement {
    static async getConfigElement() {
        await import('./media-player-config-Dej7We_w.js');
